...
const WORKS: WorkItem[] = [
  { id:101, title:'Ohara Landscape', category:'wet-plate', src:'/images/works/ohara-landscape.jpg', height:'380px', labelEn:'Wet Plate' },
  ...
  { id:16, title:'Unspoken', category:'portrait', src:'/images/works/work16.jpg', height:'380px', labelEn:'Portrait' },
  ...
  { id:4, title:'Kyoto Street', category:'wet-plate', src:'/images/works/work1.jpg', height:'380px', labelEn:'Wet Plate' },
  ...
  { id:6, title:'Landscape Study', category:'wet-plate', src:'/images/works/work2.jpg', height:'380px', labelEn:'Wet Plate' },
  { id:202, title:'Family Record', category:'film-digital', src:'/images/works/family-onbu.jpg', height:'380px', labelEn:'Film / Digital' },
  { id:11, title:'Portrait of a Boy', category:'portrait', src:'/images/works/work6.jpg', height:'400px', labelEn:'Portrait' },
  { id:8, title:'Canal and Bridge', category:'wet-plate', src:'/images/works/work7.jpg', height:'360px', labelEn:'Wet Plate' },
  { id:9, title:'Modernity', category:'wet-plate', src:'/images/works/work3.jpg', height:'380px', labelEn:'Wet Plate' },
  ...
  { id:12, title:'Garden Elements', category:'wet-plate', src:'/images/works/work5.jpg', height:'380px', labelEn:'Wet Plate' },
  { id:13, title:'Workspace', category:'wet-plate', src:'/images/works/work8.jpg', height:'380px', labelEn:'Wet Plate' },
  { id:204, title:'Family Record', category:'film-digital', src:'/images/works/family-water.jpg', height:'380px', labelEn:'Film / Digital' },
  { id:14, title:'Portrait of a Girl', category:'wet-plate', src:'/images/works/work9.jpg', height:'420px', labelEn:'Wet Plate' },
  { id:205, title:'Family Record', category:'film-digital', src:'/images/works/family-look.jpg', height:'380px', labelEn:'Film / Digital' },
  { id:15, title:'Village Road', category:'wet-plate', src:'/images/works/work10.jpg', height:'380px', labelEn:'Wet Plate' },
  { id:1, title:'Herb Harvest', category:'portrait', src:'/images/works/work14.jpg', height:'420px', labelEn:'Portrait' },
  { id:7, title:'Family Portrait', category:'portrait', src:'/images/works/work12.jpg', height:'420px', labelEn:'Portrait' },
      ...
      <div className="container">
        ...
        <div className="projects__grid">
          ...
          <ProjectCard num="P.03" label="Collaboration / 共同制作" title="108 Pieces Project" cls="img-ph-2"
            desc="現代美術作家・小枝繁昭氏のライフワークプロジェクト、108人のポートレートシリーズの一部を湿板写真でご一緒します。表現者同士の対話を通じ、対象の圧倒的な「気配」を湿板写真としてガラスに共同で定着させる試み。（2026年〜）" comingSoon />
          <ProjectCard num="P.04" label="Archive / アーカイブ" title="Fragment Archive: 戸寺町公民館" cls="img-ph-3"
            desc="「まどにうつす」── 取り壊しが決まった地元の古い公民館。かつてそこにあった日常の記憶を、建物の窓ガラスそのものへ湿板写真として定着させ、物質として後世に残すドキュメンタリー・プロジェクト。（2022年）" />
        </div>
      </div>
    </section>
  )
